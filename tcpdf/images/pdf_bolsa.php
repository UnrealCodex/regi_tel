<?php
$conexion=mysql_connect("localhost","mmigrant_admsql","HSA120as") or die("Problemas en la conexion");
...
$pdf->SetHeaderData(PDF_HEADER_LOGO.'clubmex.jpg', PDF_HEADER_LOGO_WIDTH.'30', PDF_HEADER_STRING.' ');
